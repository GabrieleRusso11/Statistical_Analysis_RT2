...
class Simulator(object):
    def __init__(self, config={}, size=(8, 8), frames_per_second=30, background=True, seed=None):
        ...
        self.arena = game(seed=seed, **config)
	...
	self._running = True  # Add a running flag to control the loop
